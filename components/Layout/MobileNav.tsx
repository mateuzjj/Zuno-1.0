...
export const MobileNav: React.FC<MobileNavProps> = ({ currentView, setView }) => {
  ...
  return (
    <>
      <nav className="md:hidden fixed bottom-4 left-4 right-4 z-[40] safe-bottom" style={{ 
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`absolute -top-2 -left-2 -right-2 -bottom-2 rounded-full transition-all duration-300 ${
                    isActive
